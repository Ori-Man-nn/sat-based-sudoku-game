...
int FindLiteral3(Root* r);//取子句中第一个flag为0的文字
int FindLiteral4(Root* r);//取ValueList正序第一个IsInit=0的变元正文字
...
int OccurTimeCount(void);//处理读取的文件中变元出现次数信息，决策DPLL过程中分裂策略的变元选取策略
